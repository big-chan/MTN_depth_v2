...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark","kaist"],
                                 default="eigen_zhou")
        ...
        self.parser.add_argument("--dataset",
                                 ...
                                 default="kitti",
                                 choices=["vk2", "kitti", "kitti_odom", "kitti_depth", "kitti_test","kaist"])
        ...
        self.parser.add_argument("--eval_split",
                                 ...
                                 default="eigen",
                                 choices=[
                                    "eigen", "eigen_benchmark", "benchmark", "odom_9", "odom_10","kaist"],
        ...
        self.parser.add_argument("--post_process",
                                 ...
                                 action="store_true")
        self.parser.add_argument("--using_attention",
                                 help="using_attention",
                                 action="store_true")
        self.parser.add_argument("--using_diff",
                                 help="using_diff",
                                 action="store_true")
        self.parser.add_argument("--scale_depth",
                                 help="scale_depth",
                                 action="store_true")
        self.parser.add_argument("--softplus",
                                 help="scale_depth",
                                 action="store_true")
        ...
        self.parser.add_argument("--compute",
                                 help="distill",
                                 action="store_true")
        self.parser.add_argument("--discriminator",
                                 help="discriminator",
                                 action="store_true")
