...
#                 --batch_size 4 --frame_ids 0 --use_stereo --model_name Kaist_diff_RGB --scale_depth\
...
# Distill
# OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=1 python train.py --height 448 --width 512 --scheduler_step_size 14 --dataset kaist --split kaist --num_epochs 50 --max_depth 50 \
#                 --batch_size 4 --frame_ids 0 --use_stereo --model_name Kaist_diff_distill --scale_depth\
#                 --data_path MTN_data --log_dir ./tmp --using_attention --using_diff --model DIFF --thermal \
#                 --load_weights_folder diffnet_640x192_ms --distill --compute \
